---
title: "MetadataExtractor: Extract Typed Metadata from Documents"
sidebarTitle: "MetadataExtractor"
description: "MetadataExtractor uses a dedicated LLM to pull typed metadata fields from text per a JSON schema, returning only validated non-null values for filtering."
---
