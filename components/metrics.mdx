...
description: "Wraps DeepEval evaluation metrics into DSPy-compatible callables for use as optimization objectives with MIPROv2, COPRO, SIMBA, GEPA, and BootstrapFewShot."
---
