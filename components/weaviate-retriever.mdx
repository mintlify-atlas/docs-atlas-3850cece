...
description: "WeaviateRetriever performs hybrid vector and keyword search against a Weaviate collection, with optional metadata filtering built from extracted schema fields."
---
