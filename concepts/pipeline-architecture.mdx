---
title: "RAG Pipeline Architecture: DSPy-Opt Five-Stage Design"
sidebarTitle: "Pipeline Architecture"
description: "DSPy-Opt's RAG pipeline runs five sequential stages — query rewriting, sub-query decomposition, metadata extraction, retrieval, and answer generation."
---
