---
title: "Add a New Dataset to DSPy-Opt"
sidebarTitle: "Adding a Dataset"
description: "Extend DSPy-Opt to a new QA dataset by creating an indexing pipeline, RAG module, optimizer scripts, and config files following the established directory pattern."
---
