---
title: "Index QA Dataset Documents into a Weaviate Collection"
sidebarTitle: "Indexing"
description: "Load a HuggingFace QA dataset, extract metadata with an LLM, generate embeddings with SentenceTransformer, and store them in Weaviate."
---
