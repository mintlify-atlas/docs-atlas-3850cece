---
title: "DSPy-Opt: Automated RAG Pipeline Optimization with DSPy"
sidebarTitle: "Introduction"
description: "DSPy-Opt automates RAG pipeline optimization using DSPy optimizers — tune prompts and few-shot examples against DeepEval metrics on five QA benchmarks."
---
...
|---|---|---|---|
| **FreshQA** (SealQA) | [vtllms/sealqa](https://huggingface.co/datasets/vtllms/sealqa) | Single-hop | Dynamic QA benchmark with diverse question types and false-premise debunking |
| **HotpotQA** | [hotpotqa/hotpot_qa](https://huggingface.co/datasets/hotpotqa/hotpot_qa) | Multi-hop | Multi-hop questions with strong supervision for supporting facts |
| **PubMedQA** | [qiaojin/PubMedQA](https://huggingface.co/datasets/qiaojin/PubMedQA) | Biomedical | Biomedical QA derived from PubMed abstracts |
| **TriviaQA** | [mandarjoshi/trivia_qa](https://huggingface.co/datasets/mandarjoshi/trivia_qa) | Trivia / factoid | Question-answer-evidence triples authored by trivia enthusiasts |
| **Wikipedia** | [wikimedia/wikipedia](https://huggingface.co/datasets/wikimedia/wikipedia) | General knowledge | Large-scale Wikipedia articles paired with WikiQA question-answer pairs |
